...
The DNA construct was sequenced and a consensus sequence was generated from the aligned reads using Bcftools. The consensus reference sequence matches the reference sequence with 100% sequencing identity. Please refer to the **`r params$construct`** report for more information.
\newline
